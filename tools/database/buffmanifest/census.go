...
var Manifest = []BuffSpec{
	...
	{
		Field: "commanding_shout", Number: 16, Scope: ScopeParty, Proto: ProtoBool, Kind: KindStatFlat,
	...
	{
		Field: "shadow_priest_dps", Number: 5, Scope: ScopeIndividual, Proto: ProtoInt32, Kind: KindManual,
	...
	{
		Field: "concentration_aura", Number: 27, Scope: ScopeParty, Proto: ProtoBool, Kind: KindPseudoMult,
	...
	{
		Field: "frost_resistance_totem", Number: 21, Scope: ScopeParty, Proto: ProtoBool, Kind: KindResistance,
	...
	{
		Field: "nature_resistance_totem", Number: 22, Scope: ScopeParty, Proto: ProtoBool, Kind: KindResistance,
	...
	{
		Field: "fire_resistance_totem", Number: 23, Scope: ScopeParty, Proto: ProtoBool, Kind: KindResistance,
	...
	{
		Field: "frost_resistance_aura", Number: 20, Scope: ScopeParty, Proto: ProtoBool, Kind: KindResistance,
	...
	{
		Field: "fire_resistance_aura", Number: 24, Scope: ScopeParty, Proto: ProtoBool, Kind: KindResistance,
	...
	{
		Field: "shadow_resistance_aura", Number: 25, Scope: ScopeParty, Proto: ProtoBool, Kind: KindResistance,
	...
	{
		Field: "aspect_of_the_wild", Number: 26, Scope: ScopeParty, Proto: ProtoBool, Kind: KindResistance,
		Go: "AspectOfTheWild", Name: "Aspect of the Wild", Owner: proto.Class_ClassHunter,
		Category: "ResistanceNature",
		Stats:    []proto.Stat{proto.Stat_StatNatureResistance},
	},
	{
		Field: "atiesh_druid", Number: 18, Scope: ScopeParty, Proto: ProtoInt32, Kind: KindItemCount,
	...
	{
		Field: "atiesh_priest", Number: 19, Scope: ScopeParty, Proto: ProtoInt32, Kind: KindItemCount,
	...
	{
		Field: "totem_twisting", Number: 17, Scope: ScopeParty, Proto: ProtoBool, Kind: KindFlag,
		Go:    "TotemTwisting",
	...
	{
		Field: "blessing_of_might", Number: 4, Scope: ScopeIndividual, Proto: ProtoBool, Kind: KindStatFlat,
	...
	{
		Field: "blessing_of_wisdom", Number: 3, Scope: ScopeIndividual, Proto: ProtoBool, Kind: KindStatFlat,
	...
	{
		Field: "innervates", Number: 6, Scope: ScopeIndividual, Proto: ProtoInt32, Kind: KindExternalCD,
	...
	{
		Field: "power_infusions", Number: 7, Scope: ScopeIndividual, Proto: ProtoInt32, Kind: KindExternalCD,
