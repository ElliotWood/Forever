...
const (
	...
	allTwoHandMask = ITEM_SUBCLASS_BIT_WEAPON_2H_AXE | ITEM_SUBCLASS_BIT_WEAPON_MACE_2H | ITEM_SUBCLASS_BIT_WEAPON_POLEARM |
		ITEM_SUBCLASS_BIT_WEAPON_SWORD_2H | ITEM_SUBCLASS_BIT_WEAPON_STAFF | ITEM_SUBCLASS_BIT_WEAPON_SPEAR
	twoHandNoSpearMask = ITEM_SUBCLASS_BIT_WEAPON_2H_AXE | ITEM_SUBCLASS_BIT_WEAPON_MACE_2H | ITEM_SUBCLASS_BIT_WEAPON_POLEARM |
		ITEM_SUBCLASS_BIT_WEAPON_SWORD_2H | ITEM_SUBCLASS_BIT_WEAPON_STAFF
)
...
const (
	RATING_MOD_DEFENSE      = 0x00000002
	RATING_MOD_DODGE        = 0x00000004
	RATING_MOD_PARRY        = 0x00000008
	RATING_MOD_BLOCK        = 0x00000010
