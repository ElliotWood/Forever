...
type BuffSpec struct {
    ...
    Proto      BuffProtoType // ProtoBool | ProtoTristate | ProtoInt32 | ProtoDouble
...
| `KindFlag`                                     | none                                                                                                                                                                                                                                                                                                                                                                | proto field only                                                                                                                           |
