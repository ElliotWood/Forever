...
- ONLY CLIENT **Improved Serpent Sting**: row 3, col 3 (0-based), max rank 5, spell 19464, prereq none
    - _client data note_: raw PosX/PosY 6820,39300 off-grid (extra zero), scaled
...
- _client data note_ Lightning Reflexes: duplicate stale node 104982 at tab2 r6 c2 ignored
...
- _client data note_ Holy Specialization: duplicate stale node 105865 at tab2 r0 c0 ignored
