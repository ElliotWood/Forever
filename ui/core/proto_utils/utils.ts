...
export const specTypeFunctions: Record<Spec, SpecTypeFunctions<any>> = {
	...
	[Spec.SpecSmitePriest]: {
		...
		optionsFromPlayer: player =>
			player.spec.oneofKind == 'smitePriest' ? player.spec.smitePriest.options || SmitePriestOptions.create() : SmitePriestOptions.create(),
	},
	[Spec.SpecWarlock]: {
...
const tankSpecs: Array<Spec> = [Spec.SpecFeralTankDruid, Spec.SpecProtectionPaladin, Spec.SpecTankWarrior];
...
export const specToLocalStorageKey: Record<Spec, string> = {
	...
	[Spec.SpecSmitePriest]: '__classic_smite_priest',
