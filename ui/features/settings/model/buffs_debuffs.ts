...
export const BUFFS_CONFIG = [
	...
	{ config: Thorns, stats: [Stat.StatDefenseRating, Stat.StatStamina] },
...
export const DEBUFFS_CONFIG = [
	...
	{ config: JudgementOfLight, stats: [Stat.StatDefenseRating] },
	...
	{ config: GiftOfArthas, stats: [Stat.StatAttackPower, Stat.StatDefenseRating] },
	{ config: DemoralizingRoar, stats: [Stat.StatStamina, Stat.StatDefenseRating] },
	{ config: DemoralizingShout, stats: [Stat.StatStamina, Stat.StatDefenseRating] },
	{ config: Screech, stats: [Stat.StatStamina, Stat.StatDefenseRating] },
	{ config: ThunderClap, stats: [Stat.StatStamina, Stat.StatDefenseRating] },
	{ config: InsectSwarm, stats: [Stat.StatStamina, Stat.StatDefenseRating] },
	{ config: ScorpidSting, stats: [Stat.StatStamina, Stat.StatDefenseRating] },
	{ config: ShadowEmbrace, stats: [Stat.StatStamina, Stat.StatDefenseRating] },
] as RenderableStatOptions[];
