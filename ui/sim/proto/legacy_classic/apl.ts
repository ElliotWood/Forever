...
export interface APLRotation {
    ...
    /**
     * @generated from protobuf field: repeated proto.APLGroup groups = 5;
     */
    groups: APLGroup[]; // Action groups that can be referenced
    /**
     * @generated from protobuf field: repeated proto.APLValueVariable value_variables = 6;
     */
    valueVariables: APLValueVariable[]; // Named reusable variables
}
/**
...
/**
 * @generated from protobuf message proto.APLGroup
 */
export interface APLGroup {
    /**
     * @generated from protobuf field: string name = 1;
     */
    name: string; // Name of the group (e.g., "careful_aim")
    /**
     * @generated from protobuf field: repeated proto.APLListItem actions = 2;
     */
    actions: APLListItem[]; // Actions in this group
    /**
     * @generated from protobuf field: repeated proto.APLValueVariable variables = 3;
     */
    variables: APLValueVariable[]; // Variables that can be used in this group
}
/**
 * NextIndex: 24 (28 is taken, same number as upstream)
 *
...
export interface APLAction {
    ...
    action: {
        ...
        oneofKind: "activateAuraWithStacks";
        /**
         * @generated from protobuf field: proto.APLActionActivateAuraWithStacks activate_aura_with_stacks = 22;
         */
        activateAuraWithStacks: APLActionActivateAuraWithStacks;
    } | {
        ...
        oneofKind: "move";
        /**
         * @generated from protobuf field: proto.APLActionMove move = 18;
         */
        move: APLActionMove;
    } | {
        oneofKind: "addComboPoints";
        /**
         * @generated from protobuf field: proto.APLActionAddComboPoints add_combo_points = 23;
         */
        addComboPoints: APLActionAddComboPoints;
    } | {
        oneofKind: "catOptimalRotationAction";
        /**
         * Class or Spec-specific actions
         *
         * @generated from protobuf field: proto.APLActionCatOptimalRotationAction cat_optimal_rotation_action = 19;
         */
        catOptimalRotationAction: APLActionCatOptimalRotationAction;
    } | {
        oneofKind: "castPaladinPrimarySeal";
        /**
         * @generated from protobuf field: proto.APLActionCastPaladinPrimarySeal cast_paladin_primary_seal = 21;
         */
        castPaladinPrimarySeal: APLActionCastPaladinPrimarySeal;
    } | {
        oneofKind: "customRotation";
        /**
         * Internal use only, not exposed in UI.
         *
         * @generated from protobuf field: proto.APLActionCustomRotation custom_rotation = 20;
         */
        customRotation: APLActionCustomRotation;
    } | {
        oneofKind: "groupReference";
        /**
         * Group reference
         *
         * @generated from protobuf field: proto.APLActionGroupReference group_reference = 28;
         */
        groupReference: APLActionGroupReference;
    } | {
        oneofKind: undefined;
    };
}
/**
 * NextIndex: 78 (numbers >= 78 below are upstream's, kept for compatibility)
 *
...
export interface APLValue {
    ...
    value: {
        ...
        oneofKind: "maxHealth";
        /**
         * @generated from protobuf field: proto.APLValueMaxHealth max_health = 76;
         */
        maxHealth: APLValueMaxHealth;
    } | {
        ...
        oneofKind: "maxMana";
        /**
         * @generated from protobuf field: proto.APLValueMaxMana max_mana = 75;
         */
        maxMana: APLValueMaxMana;
    } | {
        ...
        oneofKind: "timeToEnergyTick";
        /**
         * @generated from protobuf field: proto.APLValueTimeToEnergyTick time_to_energy_tick = 66;
         */
        timeToEnergyTick: APLValueTimeToEnergyTick;
    } | {
        oneofKind: "energyThreshold";
        /**
         * @generated from protobuf field: proto.APLValueEnergyThreshold energy_threshold = 72;
         */
        energyThreshold: APLValueEnergyThreshold;
    } | {
        oneofKind: "maxComboPoints";
        /**
         * @generated from protobuf field: proto.APLValueMaxComboPoints max_combo_points = 93;
         */
        maxComboPoints: APLValueMaxComboPoints;
    } | {
        oneofKind: "maxEnergy";
        /**
         * @generated from protobuf field: proto.APLValueMaxEnergy max_energy = 87;
         */
        maxEnergy: APLValueMaxEnergy;
    } | {
        oneofKind: "maxRage";
        /**
         * @generated from protobuf field: proto.APLValueMaxRage max_rage = 102;
         */
        maxRage: APLValueMaxRage;
    } | {
        oneofKind: "currentAttackPower";
        /**
         * Stats
         *
         * @generated from protobuf field: proto.APLValueCurrentAttackPower current_attack_power = 77;
         */
        currentAttackPower: APLValueCurrentAttackPower;
    } | {
        ...
        oneofKind: "autoSwingTime";
        /**
         * @generated from protobuf field: proto.APLValueAutoSwingTime auto_swing_time = 64;
         */
        autoSwingTime: APLValueAutoSwingTime;
    } | {
        oneofKind: "spellIsKnown";
        /**
         * Spell values
         *
         * @generated from protobuf field: proto.APLValueSpellIsKnown spell_is_known = 68;
         */
        spellIsKnown: APLValueSpellIsKnown;
    } | {
        ...
        oneofKind: "spellInFlight";
        /**
         * @generated from protobuf field: proto.APLValueSpellInFlight spell_in_flight = 73;
         */
        spellInFlight: APLValueSpellInFlight;
    } | {
        oneofKind: "spellCpm";
        /**
        ...
        oneofKind: "spellFullCooldown";
        /**
         * @generated from protobuf field: proto.APLValueSpellFullCooldown spell_full_cooldown = 116;
         */
        spellFullCooldown: APLValueSpellFullCooldown;
    } | {
        oneofKind: "auraIsKnown";
        /**
         * Aura values
         *
         * @generated from protobuf field: proto.APLValueAuraIsKnown aura_is_known = 67;
         */
        auraIsKnown: APLValueAuraIsKnown;
    } | {
        ...
        oneofKind: "auraIsInactive";
        /**
         * @generated from protobuf field: proto.APLValueAuraIsInactive aura_is_inactive = 107;
         */
        auraIsInactive: APLValueAuraIsInactive;
    } | {
        ...
        oneofKind: "auraDuration";
        /**
         * @generated from protobuf field: proto.APLValueAuraDuration aura_duration = 123;
         */
        auraDuration: APLValueAuraDuration;
    } | {
        oneofKind: "runeIsEquipped";
        /**
         * Rune values TODO: remove once APLs for classes are updated
         *
         * @generated from protobuf field: proto.APLValueRuneIsEquipped rune_is_equipped = 74;
         */
        runeIsEquipped: APLValueRuneIsEquipped;
    } | {
        ...
        oneofKind: "dotTimeToNextTick";
        /**
         * @generated from protobuf field: proto.APLValueDotTimeToNextTick dot_time_to_next_tick = 117;
         */
        dotTimeToNextTick: APLValueDotTimeToNextTick;
    } | {
        ...
        oneofKind: "warlockCurrentPetMana";
        /**
         * @generated from protobuf field: proto.APLValueWarlockCurrentPetMana warlock_current_pet_mana = 69;
         */
        warlockCurrentPetMana: APLValueWarlockCurrentPetMana;
    } | {
        oneofKind: "warlockCurrentPetManaPercent";
        /**
         * @generated from protobuf field: proto.APLValueWarlockCurrentPetManaPercent warlock_current_pet_mana_percent = 70;
         */
        warlockCurrentPetManaPercent: APLValueWarlockCurrentPetManaPercent;
    } | {
        oneofKind: "warlockPetIsActive";
        /**
         * @generated from protobuf field: proto.APLValueWarlockPetIsActive warlock_pet_is_active = 71;
         */
        warlockPetIsActive: APLValueWarlockPetIsActive;
    } | {
        oneofKind: "currentSealRemainingTime";
        /**
         * Paladin
         *
         * @generated from protobuf field: proto.APLValueCurrentSealRemainingTime current_seal_remaining_time = 65;
         */
        currentSealRemainingTime: APLValueCurrentSealRemainingTime;
    } | {
        oneofKind: "variableRef";
        /**
         * Variable reference
         *
         * @generated from protobuf field: proto.APLValueVariableRef variable_ref = 111;
         */
        variableRef: APLValueVariableRef;
    } | {
        oneofKind: "variablePlaceholder";
        /**
         * Variable placeholder, replaced by the value passed in when its group is referenced
         *
         * @generated from protobuf field: proto.APLValueVariablePlaceholder variable_placeholder = 112;
         */
        variablePlaceholder: APLValueVariablePlaceholder;
    } | {
        oneofKind: "actionGroupUsed";
        /**
         * Action Group
         *
         * @generated from protobuf field: proto.APLValueActionGroupUsed action_group_used = 124;
         */
        actionGroupUsed: APLValueActionGroupUsed;
    } | {
        oneofKind: undefined;
    };
}
...
export interface APLActionChannelSpell {
    ...
    /**
     * @generated from protobuf field: bool instant_interrupt = 4;
     */
...
/**
 * @generated from protobuf message proto.APLActionActivateAuraWithStacks
 */
export interface APLActionActivateAuraWithStacks {
    /**
     * @generated from protobuf field: proto.ActionID aura_id = 1;
     */
    auraId?: ActionID;
    /**
     * @generated from protobuf field: string num_stacks = 2;
     */
    numStacks: string;
}
/**
 * @generated from protobuf message proto.APLActionAddComboPoints
 */
export interface APLActionAddComboPoints {
    /**
     * @generated from protobuf field: string num_points = 2;
     */
    numPoints: string;
}
/**
...
export interface APLActionCatOptimalRotationAction {
    /**
     * @generated from protobuf field: int32 min_combos_for_rip = 1;
     */
    minCombosForRip: number;
    /**
     * @generated from protobuf field: float max_wait_time = 2;
     */
    maxWaitTime: number;
    /**
    ...
    /**
     * @generated from protobuf field: bool use_shred_trick = 4;
     */
    useShredTrick: boolean;
}
/**
 * @generated from protobuf message proto.APLActionCastPaladinPrimarySeal
 */
export interface APLActionCastPaladinPrimarySeal {
}
/**
...
/**
 * @generated from protobuf message proto.APLValueMaxHealth
 */
export interface APLValueMaxHealth {
}
/**
...
/**
 * @generated from protobuf message proto.APLValueMaxMana
 */
export interface APLValueMaxMana {
}
/**
...
/**
 * @generated from protobuf message proto.APLValueTimeToEnergyTick
 */
export interface APLValueTimeToEnergyTick {
}
/**
 * @generated from protobuf message proto.APLValueEnergyThreshold
 */
export interface APLValueEnergyThreshold {
    /**
     * @generated from protobuf field: int32 threshold = 1;
     */
    threshold: number;
}
/**
 * @generated from protobuf message proto.APLValueMaxComboPoints
 */
export interface APLValueMaxComboPoints {
}
/**
 * @generated from protobuf message proto.APLValueMaxEnergy
 */
export interface APLValueMaxEnergy {
}
/**
 * @generated from protobuf message proto.APLValueMaxRage
 */
export interface APLValueMaxRage {
}
/**
 * @generated from protobuf message proto.APLValueCurrentAttackPower
 */
export interface APLValueCurrentAttackPower {
}
/**
...
export interface APLValueAutoTimeToNext {
    /**
     * @generated from protobuf field: proto.APLValueAutoTimeToNext.AttackType auto_type = 1;
     */
    autoType: APLValueAutoTimeToNext_AttackType;
}
/**
 * @generated from protobuf enum proto.APLValueAutoTimeToNext.AttackType
 */
export enum APLValueAutoTimeToNext_AttackType {
    /**
     * @generated from protobuf enum value: Unknown = 0;
     */
    Unknown = 0,
    ...
    Melee = 2,
    /**
     * @generated from protobuf enum value: MainHand = 3;
     */
    MainHand = 3,
    /**
     * @generated from protobuf enum value: OffHand = 4;
     */
    OffHand = 4,
    /**
     * @generated from protobuf enum value: Ranged = 5;
     */
    Ranged = 5
}
/**
 * @generated from protobuf message proto.APLValueAutoSwingTime
 */
export interface APLValueAutoSwingTime {
    /**
     * @generated from protobuf field: proto.APLValueAutoSwingTime.SwingType auto_type = 1;
     */
    autoType: APLValueAutoSwingTime_SwingType;
}
/**
 * @generated from protobuf enum proto.APLValueAutoSwingTime.SwingType
 */
...
/**
 * @generated from protobuf message proto.APLValueSpellIsKnown
 */
export interface APLValueSpellIsKnown {
    /**
     * @generated from protobuf field: proto.ActionID spell_id = 1;
     */
    spellId?: ActionID;
...
/**
 * @generated from protobuf message proto.APLValueSpellInFlight
 */
export interface APLValueSpellInFlight {
    /**
     * @generated from protobuf field: proto.ActionID spell_id = 1;
     */
    spellId?: ActionID;
...
/**
 * @generated from protobuf message proto.APLValueSpellFullCooldown
 */
export interface APLValueSpellFullCooldown {
    /**
     * @generated from protobuf field: proto.ActionID spell_id = 1;
     */
    spellId?: ActionID;
...
/**
 * @generated from protobuf message proto.APLValueAuraIsKnown
 */
export interface APLValueAuraIsKnown {
    /**
...
/**
 * Upstream also has bool include_reaction_time = 3; not ported (needs Aura.TimeInactive).
 *
 * @generated from protobuf message proto.APLValueAuraIsInactive
 */
export interface APLValueAuraIsInactive {
    /**
     * @generated from protobuf field: proto.UnitReference source_unit = 2;
     */
    sourceUnit?: UnitReference;
...
/**
 * @generated from protobuf message proto.APLValueAuraDuration
 */
export interface APLValueAuraDuration {
    /**
     * @generated from protobuf field: proto.UnitReference source_unit = 2;
     */
    sourceUnit?: UnitReference;
 ...
 *
 * @generated from protobuf message proto.APLValueRuneIsEquipped
 */
export interface APLValueRuneIsEquipped {
    /**
     * @generated from protobuf field: proto.ActionID rune_id = 1;
     */
    runeId?: ActionID;
}
/**
...
/**
 * @generated from protobuf message proto.APLValueDotTimeToNextTick
 */
export interface APLValueDotTimeToNextTick {
    /**
     * @generated from protobuf field: proto.UnitReference target_unit = 2;
     */
    targetUnit?: UnitReference;
...
/**
 * @generated from protobuf message proto.APLValueWarlockCurrentPetMana
 */
export interface APLValueWarlockCurrentPetMana {
}
/**
 * @generated from protobuf message proto.APLValueWarlockCurrentPetManaPercent
 */
export interface APLValueWarlockCurrentPetManaPercent {
}
/**
 * @generated from protobuf message proto.APLValueWarlockPetIsActive
 */
export interface APLValueWarlockPetIsActive {
}
/**
 * @generated from protobuf message proto.APLValueCurrentSealRemainingTime
 */
export interface APLValueCurrentSealRemainingTime {
}
/**
 * @generated from protobuf message proto.APLActionGroupReference
 */
export interface APLActionGroupReference {
    /**
     * @generated from protobuf field: string group_name = 1;
     */
    groupName: string; // Name of the group to reference
    /**
     * @generated from protobuf field: repeated proto.APLValueVariable variables = 2;
     */
    variables: APLValueVariable[]; // Variables to set for this group reference
}
/**
 * @generated from protobuf message proto.APLValueVariable
 */
export interface APLValueVariable {
    /**
     * @generated from protobuf field: string name = 1;
     */
    name: string;
    /**
     * @generated from protobuf field: proto.APLValue value = 2;
     */
    value?: APLValue;
}
/**
 * @generated from protobuf message proto.APLValueVariableRef
 */
export interface APLValueVariableRef {
    /**
     * @generated from protobuf field: string name = 1;
     */
    name: string;
...
/**
 * @generated from protobuf message proto.APLValueVariablePlaceholder
 */
export interface APLValueVariablePlaceholder {
    /**
     * @generated from protobuf field: string name = 1;
     */
    name: string; // Name of the variable placeholder to expose
}
/**
 * @generated from protobuf message proto.APLValueActionGroupUsed
 */
export interface APLValueActionGroupUsed {
    /**
     * @generated from protobuf field: string name = 1;
     */
    name: string; // Name of the action group to check
}
// /////////////////////////////////////////////////////////////////////////
//                                  VALUES
// /////////////////////////////////////////////////////////////////////////
...
class APLRotation$Type extends MessageType<APLRotation> {
    constructor() {
        super("proto.APLRotation", [
            ...
            { no: 5, name: "groups", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => APLGroup },
            { no: 6, name: "value_variables", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => APLValueVariable }
        ]);
    }
    create(value?: PartialMessage<APLRotation>): APLRotation {
        const message = { type: 0, prepullActions: [], priorityList: [], groups: [], valueVariables: [] };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated proto.APLListItem priority_list */ 2:
                    ...
                    break;
                case /* repeated proto.APLGroup groups */ 5:
                    message.groups.push(APLGroup.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated proto.APLValueVariable value_variables */ 6:
                    message.valueVariables.push(APLValueVariable.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
    ...
    internalBinaryWrite(message: APLRotation, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated proto.APLGroup groups = 5; */
        for (let i = 0; i < message.groups.length; i++)
            APLGroup.internalBinaryWrite(message.groups[i], writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        /* repeated proto.APLValueVariable value_variables = 6; */
        for (let i = 0; i < message.valueVariables.length; i++)
            APLValueVariable.internalBinaryWrite(message.valueVariables[i], writer.tag(6, WireType.LengthDelimited).fork(), options).join();
...
// @generated message type with reflection information, may provide speed optimized methods
class APLGroup$Type extends MessageType<APLGroup> {
    constructor() {
        super("proto.APLGroup", [
            { no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "actions", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => APLListItem },
            { no: 3, name: "variables", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => APLValueVariable }
        ]);
    }
    create(value?: PartialMessage<APLGroup>): APLGroup {
        const message = { name: "", actions: [], variables: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLGroup>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLGroup): APLGroup {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* string name */ 1:
                    ...
                    break;
                case /* repeated proto.APLListItem actions */ 2:
                    message.actions.push(APLListItem.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated proto.APLValueVariable variables */ 3:
                    message.variables.push(APLValueVariable.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: APLGroup, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string name = 1; */
        if (message.name !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.name);
        /* repeated proto.APLListItem actions = 2; */
        for (let i = 0; i < message.actions.length; i++)
            APLListItem.internalBinaryWrite(message.actions[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* repeated proto.APLValueVariable variables = 3; */
        for (let i = 0; i < message.variables.length; i++)
            APLValueVariable.internalBinaryWrite(message.variables[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message proto.APLGroup
 */
export const APLGroup = new APLGroup$Type();
// @generated message type with reflection information, may provide speed optimized methods
class APLAction$Type extends MessageType<APLAction> {
    constructor() {
        super("proto.APLAction", [
            ...
            { no: 22, name: "activate_aura_with_stacks", kind: "message", oneof: "action", T: () => APLActionActivateAuraWithStacks },
            ...
            { no: 18, name: "move", kind: "message", oneof: "action", T: () => APLActionMove },
            { no: 23, name: "add_combo_points", kind: "message", oneof: "action", T: () => APLActionAddComboPoints },
            { no: 19, name: "cat_optimal_rotation_action", kind: "message", oneof: "action", T: () => APLActionCatOptimalRotationAction },
            { no: 21, name: "cast_paladin_primary_seal", kind: "message", oneof: "action", T: () => APLActionCastPaladinPrimarySeal },
            { no: 20, name: "custom_rotation", kind: "message", oneof: "action", T: () => APLActionCustomRotation },
            { no: 28, name: "group_reference", kind: "message", oneof: "action", T: () => APLActionGroupReference }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* proto.APLActionActivateAura activate_aura */ 13:
                    ...
                    break;
                case /* proto.APLActionActivateAuraWithStacks activate_aura_with_stacks */ 22:
                    message.action = {
                        oneofKind: "activateAuraWithStacks",
                        activateAuraWithStacks: APLActionActivateAuraWithStacks.internalBinaryRead(reader, reader.uint32(), options, (message.action as any).activateAuraWithStacks)
                    };
                    break;
                ...
                case /* proto.APLActionItemSwap item_swap */ 17:
                    ...
                    break;
                case /* proto.APLActionMove move */ 18:
                    message.action = {
                        oneofKind: "move",
                        move: APLActionMove.internalBinaryRead(reader, reader.uint32(), options, (message.action as any).move)
                    };
                    break;
                case /* proto.APLActionAddComboPoints add_combo_points */ 23:
                    message.action = {
                        oneofKind: "addComboPoints",
                        addComboPoints: APLActionAddComboPoints.internalBinaryRead(reader, reader.uint32(), options, (message.action as any).addComboPoints)
                    };
                    break;
                case /* proto.APLActionCatOptimalRotationAction cat_optimal_rotation_action */ 19:
                    message.action = {
                        oneofKind: "catOptimalRotationAction",
                    ...
                    break;
                case /* proto.APLActionCastPaladinPrimarySeal cast_paladin_primary_seal */ 21:
                    message.action = {
                        oneofKind: "castPaladinPrimarySeal",
                        castPaladinPrimarySeal: APLActionCastPaladinPrimarySeal.internalBinaryRead(reader, reader.uint32(), options, (message.action as any).castPaladinPrimarySeal)
                    };
                    break;
                case /* proto.APLActionCustomRotation custom_rotation */ 20:
                    message.action = {
                        oneofKind: "customRotation",
                    ...
                    break;
                case /* proto.APLActionGroupReference group_reference */ 28:
                    message.action = {
                        oneofKind: "groupReference",
                        groupReference: APLActionGroupReference.internalBinaryRead(reader, reader.uint32(), options, (message.action as any).groupReference)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: APLAction, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* proto.APLActionActivateAuraWithStacks activate_aura_with_stacks = 22; */
        if (message.action.oneofKind === "activateAuraWithStacks")
            APLActionActivateAuraWithStacks.internalBinaryWrite(message.action.activateAuraWithStacks, writer.tag(22, WireType.LengthDelimited).fork(), options).join();
        ...
        /* proto.APLActionMove move = 18; */
        if (message.action.oneofKind === "move")
            APLActionMove.internalBinaryWrite(message.action.move, writer.tag(18, WireType.LengthDelimited).fork(), options).join();
        /* proto.APLActionAddComboPoints add_combo_points = 23; */
        if (message.action.oneofKind === "addComboPoints")
            APLActionAddComboPoints.internalBinaryWrite(message.action.addComboPoints, writer.tag(23, WireType.LengthDelimited).fork(), options).join();
        /* proto.APLActionCatOptimalRotationAction cat_optimal_rotation_action = 19; */
        if (message.action.oneofKind === "catOptimalRotationAction")
            APLActionCatOptimalRotationAction.internalBinaryWrite(message.action.catOptimalRotationAction, writer.tag(19, WireType.LengthDelimited).fork(), options).join();
        /* proto.APLActionCastPaladinPrimarySeal cast_paladin_primary_seal = 21; */
        if (message.action.oneofKind === "castPaladinPrimarySeal")
            APLActionCastPaladinPrimarySeal.internalBinaryWrite(message.action.castPaladinPrimarySeal, writer.tag(21, WireType.LengthDelimited).fork(), options).join();
        /* proto.APLActionCustomRotation custom_rotation = 20; */
        if (message.action.oneofKind === "customRotation")
            APLActionCustomRotation.internalBinaryWrite(message.action.customRotation, writer.tag(20, WireType.LengthDelimited).fork(), options).join();
        /* proto.APLActionGroupReference group_reference = 28; */
        if (message.action.oneofKind === "groupReference")
            APLActionGroupReference.internalBinaryWrite(message.action.groupReference, writer.tag(28, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class APLValue$Type extends MessageType<APLValue> {
    constructor() {
        super("proto.APLValue", [
            ...
            { no: 76, name: "max_health", kind: "message", oneof: "value", T: () => APLValueMaxHealth },
            ...
            { no: 75, name: "max_mana", kind: "message", oneof: "value", T: () => APLValueMaxMana },
            ...
            { no: 66, name: "time_to_energy_tick", kind: "message", oneof: "value", T: () => APLValueTimeToEnergyTick },
            { no: 72, name: "energy_threshold", kind: "message", oneof: "value", T: () => APLValueEnergyThreshold },
            { no: 93, name: "max_combo_points", kind: "message", oneof: "value", T: () => APLValueMaxComboPoints },
            { no: 87, name: "max_energy", kind: "message", oneof: "value", T: () => APLValueMaxEnergy },
            { no: 102, name: "max_rage", kind: "message", oneof: "value", T: () => APLValueMaxRage },
            { no: 77, name: "current_attack_power", kind: "message", oneof: "value", T: () => APLValueCurrentAttackPower },
            ...
            { no: 64, name: "auto_swing_time", kind: "message", oneof: "value", T: () => APLValueAutoSwingTime },
            { no: 68, name: "spell_is_known", kind: "message", oneof: "value", T: () => APLValueSpellIsKnown },
            ...
            { no: 73, name: "spell_in_flight", kind: "message", oneof: "value", T: () => APLValueSpellInFlight },
            ...
            { no: 116, name: "spell_full_cooldown", kind: "message", oneof: "value", T: () => APLValueSpellFullCooldown },
            { no: 67, name: "aura_is_known", kind: "message", oneof: "value", T: () => APLValueAuraIsKnown },
            { no: 22, name: "aura_is_active", kind: "message", oneof: "value", T: () => APLValueAuraIsActive },
            { no: 107, name: "aura_is_inactive", kind: "message", oneof: "value", T: () => APLValueAuraIsInactive },
            ...
            { no: 123, name: "aura_duration", kind: "message", oneof: "value", T: () => APLValueAuraDuration },
            { no: 74, name: "rune_is_equipped", kind: "message", oneof: "value", T: () => APLValueRuneIsEquipped },
            ...
            { no: 117, name: "dot_time_to_next_tick", kind: "message", oneof: "value", T: () => APLValueDotTimeToNextTick },
            ...
            { no: 69, name: "warlock_current_pet_mana", kind: "message", oneof: "value", T: () => APLValueWarlockCurrentPetMana },
            { no: 70, name: "warlock_current_pet_mana_percent", kind: "message", oneof: "value", T: () => APLValueWarlockCurrentPetManaPercent },
            { no: 71, name: "warlock_pet_is_active", kind: "message", oneof: "value", T: () => APLValueWarlockPetIsActive },
            { no: 65, name: "current_seal_remaining_time", kind: "message", oneof: "value", T: () => APLValueCurrentSealRemainingTime },
            { no: 111, name: "variable_ref", kind: "message", oneof: "value", T: () => APLValueVariableRef },
            { no: 112, name: "variable_placeholder", kind: "message", oneof: "value", T: () => APLValueVariablePlaceholder },
            { no: 124, name: "action_group_used", kind: "message", oneof: "value", T: () => APLValueActionGroupUsed }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* proto.APLValueCurrentHealthPercent current_health_percent */ 27:
                    ...
                    break;
                case /* proto.APLValueMaxHealth max_health */ 76:
                    message.value = {
                        oneofKind: "maxHealth",
                        maxHealth: APLValueMaxHealth.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).maxHealth)
                    };
                    break;
                ...
                case /* proto.APLValueCurrentManaPercent current_mana_percent */ 12:
                    ...
                    break;
                case /* proto.APLValueMaxMana max_mana */ 75:
                    message.value = {
                        oneofKind: "maxMana",
                        maxMana: APLValueMaxMana.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).maxMana)
                    };
                    break;
                ...
                case /* proto.APLValueCurrentComboPoints current_combo_points */ 16:
                    ...
                    break;
                case /* proto.APLValueTimeToEnergyTick time_to_energy_tick */ 66:
                    message.value = {
                        oneofKind: "timeToEnergyTick",
                        timeToEnergyTick: APLValueTimeToEnergyTick.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).timeToEnergyTick)
                    };
                    break;
                case /* proto.APLValueEnergyThreshold energy_threshold */ 72:
                    message.value = {
                        oneofKind: "energyThreshold",
                        energyThreshold: APLValueEnergyThreshold.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).energyThreshold)
                    };
                    break;
                case /* proto.APLValueMaxComboPoints max_combo_points */ 93:
                    message.value = {
                        oneofKind: "maxComboPoints",
                        maxComboPoints: APLValueMaxComboPoints.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).maxComboPoints)
                    };
                    break;
                case /* proto.APLValueMaxEnergy max_energy */ 87:
                    message.value = {
                        oneofKind: "maxEnergy",
                        maxEnergy: APLValueMaxEnergy.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).maxEnergy)
                    };
                    break;
                case /* proto.APLValueMaxRage max_rage */ 102:
                    message.value = {
                        oneofKind: "maxRage",
                        maxRage: APLValueMaxRage.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).maxRage)
                    };
                    break;
                case /* proto.APLValueCurrentAttackPower current_attack_power */ 77:
                    message.value = {
                        oneofKind: "currentAttackPower",
                        currentAttackPower: APLValueCurrentAttackPower.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).currentAttackPower)
                    };
                    break;
                ...
                case /* proto.APLValueAutoTimeToNext auto_time_to_next */ 40:
                    ...
                    break;
                case /* proto.APLValueAutoSwingTime auto_swing_time */ 64:
                    message.value = {
                        oneofKind: "autoSwingTime",
                        autoSwingTime: APLValueAutoSwingTime.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).autoSwingTime)
                    };
                    break;
                case /* proto.APLValueSpellIsKnown spell_is_known */ 68:
                    message.value = {
                        oneofKind: "spellIsKnown",
                        spellIsKnown: APLValueSpellIsKnown.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).spellIsKnown)
                    };
                    break;
                ...
                case /* proto.APLValueSpellTravelTime spell_travel_time */ 37:
                    ...
                    break;
                case /* proto.APLValueSpellInFlight spell_in_flight */ 73:
                    message.value = {
                        oneofKind: "spellInFlight",
                        spellInFlight: APLValueSpellInFlight.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).spellInFlight)
                    };
                    break;
                ...
                case /* proto.APLValueSpellCurrentCost spell_current_cost */ 62:
                    ...
                    break;
                case /* proto.APLValueSpellFullCooldown spell_full_cooldown */ 116:
                    message.value = {
                        oneofKind: "spellFullCooldown",
                        spellFullCooldown: APLValueSpellFullCooldown.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).spellFullCooldown)
                    };
                    break;
                case /* proto.APLValueAuraIsKnown aura_is_known */ 67:
                    message.value = {
                        oneofKind: "auraIsKnown",
                        auraIsKnown: APLValueAuraIsKnown.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).auraIsKnown)
                    };
                    break;
                case /* proto.APLValueAuraIsActive aura_is_active */ 22:
                    ...
                    break;
                case /* proto.APLValueAuraIsInactive aura_is_inactive */ 107:
                    message.value = {
                        oneofKind: "auraIsInactive",
                        auraIsInactive: APLValueAuraIsInactive.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).auraIsInactive)
                    };
                    break;
                ...
                case /* proto.APLValueAuraShouldRefresh aura_should_refresh */ 43:
                    ...
                    break;
                case /* proto.APLValueAuraDuration aura_duration */ 123:
                    message.value = {
                        oneofKind: "auraDuration",
                        auraDuration: APLValueAuraDuration.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).auraDuration)
                    };
                    break;
                case /* proto.APLValueRuneIsEquipped rune_is_equipped */ 74:
                    message.value = {
                        oneofKind: "runeIsEquipped",
                        runeIsEquipped: APLValueRuneIsEquipped.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).runeIsEquipped)
                    };
                    break;
                ...
                case /* proto.APLValueDotRemainingTime dot_remaining_time */ 13:
                    ...
                    break;
                case /* proto.APLValueDotTimeToNextTick dot_time_to_next_tick */ 117:
                    message.value = {
                        oneofKind: "dotTimeToNextTick",
                        dotTimeToNextTick: APLValueDotTimeToNextTick.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).dotTimeToNextTick)
                    };
                    break;
                ...
                case /* proto.APLValueWarlockShouldRefreshCorruption warlock_should_refresh_corruption */ 60:
                    ...
                    break;
                case /* proto.APLValueWarlockCurrentPetMana warlock_current_pet_mana */ 69:
                    message.value = {
                        oneofKind: "warlockCurrentPetMana",
                        warlockCurrentPetMana: APLValueWarlockCurrentPetMana.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).warlockCurrentPetMana)
                    };
                    break;
                case /* proto.APLValueWarlockCurrentPetManaPercent warlock_current_pet_mana_percent */ 70:
                    message.value = {
                        oneofKind: "warlockCurrentPetManaPercent",
                        warlockCurrentPetManaPercent: APLValueWarlockCurrentPetManaPercent.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).warlockCurrentPetManaPercent)
                    };
                    break;
                case /* proto.APLValueWarlockPetIsActive warlock_pet_is_active */ 71:
                    message.value = {
                        oneofKind: "warlockPetIsActive",
                        warlockPetIsActive: APLValueWarlockPetIsActive.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).warlockPetIsActive)
                    };
                    break;
                case /* proto.APLValueCurrentSealRemainingTime current_seal_remaining_time */ 65:
                    message.value = {
                        oneofKind: "currentSealRemainingTime",
                        currentSealRemainingTime: APLValueCurrentSealRemainingTime.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).currentSealRemainingTime)
                    };
                    break;
                case /* proto.APLValueVariableRef variable_ref */ 111:
                    message.value = {
                        oneofKind: "variableRef",
                        variableRef: APLValueVariableRef.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).variableRef)
                    };
                    break;
                case /* proto.APLValueVariablePlaceholder variable_placeholder */ 112:
                    message.value = {
                        oneofKind: "variablePlaceholder",
                        variablePlaceholder: APLValueVariablePlaceholder.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).variablePlaceholder)
                    };
                    break;
                case /* proto.APLValueActionGroupUsed action_group_used */ 124:
                    message.value = {
                        oneofKind: "actionGroupUsed",
                        actionGroupUsed: APLValueActionGroupUsed.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).actionGroupUsed)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: APLValue, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* proto.APLValueMaxHealth max_health = 76; */
        if (message.value.oneofKind === "maxHealth")
            APLValueMaxHealth.internalBinaryWrite(message.value.maxHealth, writer.tag(76, WireType.LengthDelimited).fork(), options).join();
        ...
        /* proto.APLValueMaxMana max_mana = 75; */
        if (message.value.oneofKind === "maxMana")
            APLValueMaxMana.internalBinaryWrite(message.value.maxMana, writer.tag(75, WireType.LengthDelimited).fork(), options).join();
        ...
        /* proto.APLValueTimeToEnergyTick time_to_energy_tick = 66; */
        if (message.value.oneofKind === "timeToEnergyTick")
            APLValueTimeToEnergyTick.internalBinaryWrite(message.value.timeToEnergyTick, writer.tag(66, WireType.LengthDelimited).fork(), options).join();
        /* proto.APLValueEnergyThreshold energy_threshold = 72; */
        if (message.value.oneofKind === "energyThreshold")
            APLValueEnergyThreshold.internalBinaryWrite(message.value.energyThreshold, writer.tag(72, WireType.LengthDelimited).fork(), options).join();
        /* proto.APLValueMaxComboPoints max_combo_points = 93; */
        if (message.value.oneofKind === "maxComboPoints")
            APLValueMaxComboPoints.internalBinaryWrite(message.value.maxComboPoints, writer.tag(93, WireType.LengthDelimited).fork(), options).join();
        /* proto.APLValueMaxEnergy max_energy = 87; */
        if (message.value.oneofKind === "maxEnergy")
            APLValueMaxEnergy.internalBinaryWrite(message.value.maxEnergy, writer.tag(87, WireType.LengthDelimited).fork(), options).join();
        /* proto.APLValueMaxRage max_rage = 102; */
        if (message.value.oneofKind === "maxRage")
            APLValueMaxRage.internalBinaryWrite(message.value.maxRage, writer.tag(102, WireType.LengthDelimited).fork(), options).join();
        /* proto.APLValueCurrentAttackPower current_attack_power = 77; */
        if (message.value.oneofKind === "currentAttackPower")
            APLValueCurrentAttackPower.internalBinaryWrite(message.value.currentAttackPower, writer.tag(77, WireType.LengthDelimited).fork(), options).join();
        ...
        /* proto.APLValueAutoSwingTime auto_swing_time = 64; */
        if (message.value.oneofKind === "autoSwingTime")
            APLValueAutoSwingTime.internalBinaryWrite(message.value.autoSwingTime, writer.tag(64, WireType.LengthDelimited).fork(), options).join();
        /* proto.APLValueSpellIsKnown spell_is_known = 68; */
        if (message.value.oneofKind === "spellIsKnown")
            APLValueSpellIsKnown.internalBinaryWrite(message.value.spellIsKnown, writer.tag(68, WireType.LengthDelimited).fork(), options).join();
        ...
        /* proto.APLValueSpellInFlight spell_in_flight = 73; */
        if (message.value.oneofKind === "spellInFlight")
            APLValueSpellInFlight.internalBinaryWrite(message.value.spellInFlight, writer.tag(73, WireType.LengthDelimited).fork(), options).join();
        ...
        /* proto.APLValueSpellFullCooldown spell_full_cooldown = 116; */
        if (message.value.oneofKind === "spellFullCooldown")
            APLValueSpellFullCooldown.internalBinaryWrite(message.value.spellFullCooldown, writer.tag(116, WireType.LengthDelimited).fork(), options).join();
        /* proto.APLValueAuraIsKnown aura_is_known = 67; */
        if (message.value.oneofKind === "auraIsKnown")
            APLValueAuraIsKnown.internalBinaryWrite(message.value.auraIsKnown, writer.tag(67, WireType.LengthDelimited).fork(), options).join();
        ...
        /* proto.APLValueAuraIsInactive aura_is_inactive = 107; */
        if (message.value.oneofKind === "auraIsInactive")
            APLValueAuraIsInactive.internalBinaryWrite(message.value.auraIsInactive, writer.tag(107, WireType.LengthDelimited).fork(), options).join();
        ...
        /* proto.APLValueAuraDuration aura_duration = 123; */
        if (message.value.oneofKind === "auraDuration")
            APLValueAuraDuration.internalBinaryWrite(message.value.auraDuration, writer.tag(123, WireType.LengthDelimited).fork(), options).join();
        /* proto.APLValueRuneIsEquipped rune_is_equipped = 74; */
        if (message.value.oneofKind === "runeIsEquipped")
            APLValueRuneIsEquipped.internalBinaryWrite(message.value.runeIsEquipped, writer.tag(74, WireType.LengthDelimited).fork(), options).join();
        ...
        /* proto.APLValueDotTimeToNextTick dot_time_to_next_tick = 117; */
        if (message.value.oneofKind === "dotTimeToNextTick")
            APLValueDotTimeToNextTick.internalBinaryWrite(message.value.dotTimeToNextTick, writer.tag(117, WireType.LengthDelimited).fork(), options).join();
        ...
        /* proto.APLValueWarlockCurrentPetMana warlock_current_pet_mana = 69; */
        if (message.value.oneofKind === "warlockCurrentPetMana")
            APLValueWarlockCurrentPetMana.internalBinaryWrite(message.value.warlockCurrentPetMana, writer.tag(69, WireType.LengthDelimited).fork(), options).join();
        /* proto.APLValueWarlockCurrentPetManaPercent warlock_current_pet_mana_percent = 70; */
        if (message.value.oneofKind === "warlockCurrentPetManaPercent")
            APLValueWarlockCurrentPetManaPercent.internalBinaryWrite(message.value.warlockCurrentPetManaPercent, writer.tag(70, WireType.LengthDelimited).fork(), options).join();
        /* proto.APLValueWarlockPetIsActive warlock_pet_is_active = 71; */
        if (message.value.oneofKind === "warlockPetIsActive")
            APLValueWarlockPetIsActive.internalBinaryWrite(message.value.warlockPetIsActive, writer.tag(71, WireType.LengthDelimited).fork(), options).join();
        /* proto.APLValueCurrentSealRemainingTime current_seal_remaining_time = 65; */
        if (message.value.oneofKind === "currentSealRemainingTime")
            APLValueCurrentSealRemainingTime.internalBinaryWrite(message.value.currentSealRemainingTime, writer.tag(65, WireType.LengthDelimited).fork(), options).join();
        /* proto.APLValueVariableRef variable_ref = 111; */
        if (message.value.oneofKind === "variableRef")
            APLValueVariableRef.internalBinaryWrite(message.value.variableRef, writer.tag(111, WireType.LengthDelimited).fork(), options).join();
        /* proto.APLValueVariablePlaceholder variable_placeholder = 112; */
        if (message.value.oneofKind === "variablePlaceholder")
            APLValueVariablePlaceholder.internalBinaryWrite(message.value.variablePlaceholder, writer.tag(112, WireType.LengthDelimited).fork(), options).join();
        /* proto.APLValueActionGroupUsed action_group_used = 124; */
        if (message.value.oneofKind === "actionGroupUsed")
            APLValueActionGroupUsed.internalBinaryWrite(message.value.actionGroupUsed, writer.tag(124, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class APLActionChannelSpell$Type extends MessageType<APLActionChannelSpell> {
    constructor() {
        super("proto.APLActionChannelSpell", [
            ...
            { no: 4, name: "instant_interrupt", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
    ...
    create(value?: PartialMessage<APLActionChannelSpell>): APLActionChannelSpell {
        const message = { instantInterrupt: false, allowRecast: false };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* proto.APLValue interrupt_if */ 3:
                    ...
                    break;
                case /* bool instant_interrupt */ 4:
                    message.instantInterrupt = reader.bool();
                    break;
    ...
    internalBinaryWrite(message: APLActionChannelSpell, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.instantInterrupt !== false)
            writer.tag(4, WireType.Varint).bool(message.instantInterrupt);
        /* bool allow_recast = 5; */
...
// @generated message type with reflection information, may provide speed optimized methods
class APLActionActivateAuraWithStacks$Type extends MessageType<APLActionActivateAuraWithStacks> {
    constructor() {
        super("proto.APLActionActivateAuraWithStacks", [
            { no: 1, name: "aura_id", kind: "message", T: () => ActionID },
            { no: 2, name: "num_stacks", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<APLActionActivateAuraWithStacks>): APLActionActivateAuraWithStacks {
        const message = { numStacks: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLActionActivateAuraWithStacks>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLActionActivateAuraWithStacks): APLActionActivateAuraWithStacks {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* proto.ActionID aura_id */ 1:
                    message.auraId = ActionID.internalBinaryRead(reader, reader.uint32(), options, message.auraId);
                    break;
                case /* string num_stacks */ 2:
                    message.numStacks = reader.string();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: APLActionActivateAuraWithStacks, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* proto.ActionID aura_id = 1; */
        if (message.auraId)
            ActionID.internalBinaryWrite(message.auraId, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* string num_stacks = 2; */
        if (message.numStacks !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.numStacks);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message proto.APLActionActivateAuraWithStacks
 */
export const APLActionActivateAuraWithStacks = new APLActionActivateAuraWithStacks$Type();
// @generated message type with reflection information, may provide speed optimized methods
class APLActionAddComboPoints$Type extends MessageType<APLActionAddComboPoints> {
    constructor() {
        super("proto.APLActionAddComboPoints", [
            { no: 2, name: "num_points", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<APLActionAddComboPoints>): APLActionAddComboPoints {
        const message = { numPoints: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLActionAddComboPoints>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLActionAddComboPoints): APLActionAddComboPoints {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* string num_points */ 2:
                    message.numPoints = reader.string();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: APLActionAddComboPoints, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string num_points = 2; */
        if (message.numPoints !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.numPoints);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message proto.APLActionAddComboPoints
 */
export const APLActionAddComboPoints = new APLActionAddComboPoints$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class APLActionCatOptimalRotationAction$Type extends MessageType<APLActionCatOptimalRotationAction> {
    constructor() {
        super("proto.APLActionCatOptimalRotationAction", [
            { no: 1, name: "min_combos_for_rip", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 2, name: "max_wait_time", kind: "scalar", T: 2 /*ScalarType.FLOAT*/ },
            { no: 3, name: "maintain_faerie_fire", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 4, name: "use_shred_trick", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
    create(value?: PartialMessage<APLActionCatOptimalRotationAction>): APLActionCatOptimalRotationAction {
        const message = { minCombosForRip: 0, maxWaitTime: 0, maintainFaerieFire: false, useShredTrick: false };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryWrite(message: APLActionCatOptimalRotationAction, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.minCombosForRip !== 0)
            writer.tag(1, WireType.Varint).int32(message.minCombosForRip);
        /* float max_wait_time = 2; */
        if (message.maxWaitTime !== 0)
            writer.tag(2, WireType.Bit32).float(message.maxWaitTime);
        ...
        if (message.useShredTrick !== false)
            writer.tag(4, WireType.Varint).bool(message.useShredTrick);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class APLActionCastPaladinPrimarySeal$Type extends MessageType<APLActionCastPaladinPrimarySeal> {
    constructor() {
        super("proto.APLActionCastPaladinPrimarySeal", []);
    }
    create(value?: PartialMessage<APLActionCastPaladinPrimarySeal>): APLActionCastPaladinPrimarySeal {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLActionCastPaladinPrimarySeal>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLActionCastPaladinPrimarySeal): APLActionCastPaladinPrimarySeal {
        return target ?? this.create();
    }
    internalBinaryWrite(message: APLActionCastPaladinPrimarySeal, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message proto.APLActionCastPaladinPrimarySeal
 */
export const APLActionCastPaladinPrimarySeal = new APLActionCastPaladinPrimarySeal$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
// @generated message type with reflection information, may provide speed optimized methods
class APLValueMaxHealth$Type extends MessageType<APLValueMaxHealth> {
    constructor() {
        super("proto.APLValueMaxHealth", []);
    }
    create(value?: PartialMessage<APLValueMaxHealth>): APLValueMaxHealth {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueMaxHealth>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueMaxHealth): APLValueMaxHealth {
        return target ?? this.create();
    }
    internalBinaryWrite(message: APLValueMaxHealth, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message proto.APLValueMaxHealth
 */
export const APLValueMaxHealth = new APLValueMaxHealth$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
// @generated message type with reflection information, may provide speed optimized methods
class APLValueMaxMana$Type extends MessageType<APLValueMaxMana> {
    constructor() {
        super("proto.APLValueMaxMana", []);
    }
    create(value?: PartialMessage<APLValueMaxMana>): APLValueMaxMana {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueMaxMana>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueMaxMana): APLValueMaxMana {
        return target ?? this.create();
    }
    internalBinaryWrite(message: APLValueMaxMana, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message proto.APLValueMaxMana
 */
export const APLValueMaxMana = new APLValueMaxMana$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
// @generated message type with reflection information, may provide speed optimized methods
class APLValueTimeToEnergyTick$Type extends MessageType<APLValueTimeToEnergyTick> {
    constructor() {
        super("proto.APLValueTimeToEnergyTick", []);
    }
    create(value?: PartialMessage<APLValueTimeToEnergyTick>): APLValueTimeToEnergyTick {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueTimeToEnergyTick>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueTimeToEnergyTick): APLValueTimeToEnergyTick {
        return target ?? this.create();
    }
    internalBinaryWrite(message: APLValueTimeToEnergyTick, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message proto.APLValueTimeToEnergyTick
 */
export const APLValueTimeToEnergyTick = new APLValueTimeToEnergyTick$Type();
// @generated message type with reflection information, may provide speed optimized methods
class APLValueEnergyThreshold$Type extends MessageType<APLValueEnergyThreshold> {
    constructor() {
        super("proto.APLValueEnergyThreshold", [
            { no: 1, name: "threshold", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value?: PartialMessage<APLValueEnergyThreshold>): APLValueEnergyThreshold {
        const message = { threshold: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueEnergyThreshold>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueEnergyThreshold): APLValueEnergyThreshold {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* int32 threshold */ 1:
                    message.threshold = reader.int32();
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: APLValueEnergyThreshold, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int32 threshold = 1; */
        if (message.threshold !== 0)
            writer.tag(1, WireType.Varint).int32(message.threshold);
        let u = options.writeUnknownFields;
...
/**
 * @generated MessageType for protobuf message proto.APLValueEnergyThreshold
 */
export const APLValueEnergyThreshold = new APLValueEnergyThreshold$Type();
// @generated message type with reflection information, may provide speed optimized methods
class APLValueMaxComboPoints$Type extends MessageType<APLValueMaxComboPoints> {
    constructor() {
        super("proto.APLValueMaxComboPoints", []);
    }
    create(value?: PartialMessage<APLValueMaxComboPoints>): APLValueMaxComboPoints {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueMaxComboPoints>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueMaxComboPoints): APLValueMaxComboPoints {
        return target ?? this.create();
    }
    internalBinaryWrite(message: APLValueMaxComboPoints, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message proto.APLValueMaxComboPoints
 */
export const APLValueMaxComboPoints = new APLValueMaxComboPoints$Type();
// @generated message type with reflection information, may provide speed optimized methods
class APLValueMaxEnergy$Type extends MessageType<APLValueMaxEnergy> {
    constructor() {
        super("proto.APLValueMaxEnergy", []);
    }
    create(value?: PartialMessage<APLValueMaxEnergy>): APLValueMaxEnergy {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueMaxEnergy>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueMaxEnergy): APLValueMaxEnergy {
        return target ?? this.create();
    }
    internalBinaryWrite(message: APLValueMaxEnergy, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message proto.APLValueMaxEnergy
 */
export const APLValueMaxEnergy = new APLValueMaxEnergy$Type();
// @generated message type with reflection information, may provide speed optimized methods
class APLValueMaxRage$Type extends MessageType<APLValueMaxRage> {
    constructor() {
        super("proto.APLValueMaxRage", []);
    }
    create(value?: PartialMessage<APLValueMaxRage>): APLValueMaxRage {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueMaxRage>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueMaxRage): APLValueMaxRage {
        return target ?? this.create();
    }
    internalBinaryWrite(message: APLValueMaxRage, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message proto.APLValueMaxRage
 */
export const APLValueMaxRage = new APLValueMaxRage$Type();
// @generated message type with reflection information, may provide speed optimized methods
class APLValueCurrentAttackPower$Type extends MessageType<APLValueCurrentAttackPower> {
    constructor() {
        super("proto.APLValueCurrentAttackPower", []);
    }
    create(value?: PartialMessage<APLValueCurrentAttackPower>): APLValueCurrentAttackPower {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueCurrentAttackPower>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueCurrentAttackPower): APLValueCurrentAttackPower {
        return target ?? this.create();
    }
    internalBinaryWrite(message: APLValueCurrentAttackPower, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message proto.APLValueCurrentAttackPower
 */
export const APLValueCurrentAttackPower = new APLValueCurrentAttackPower$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class APLValueAutoTimeToNext$Type extends MessageType<APLValueAutoTimeToNext> {
    constructor() {
        super("proto.APLValueAutoTimeToNext", [
            { no: 1, name: "auto_type", kind: "enum", T: () => ["proto.APLValueAutoTimeToNext.AttackType", APLValueAutoTimeToNext_AttackType] }
        ]);
    }
    create(value?: PartialMessage<APLValueAutoTimeToNext>): APLValueAutoTimeToNext {
        const message = { autoType: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueAutoTimeToNext): APLValueAutoTimeToNext {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* proto.APLValueAutoTimeToNext.AttackType auto_type */ 1:
    ...
    internalBinaryWrite(message: APLValueAutoTimeToNext, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* proto.APLValueAutoTimeToNext.AttackType auto_type = 1; */
        if (message.autoType !== 0)
            writer.tag(1, WireType.Varint).int32(message.autoType);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class APLValueAutoSwingTime$Type extends MessageType<APLValueAutoSwingTime> {
    constructor() {
        super("proto.APLValueAutoSwingTime", [
            { no: 1, name: "auto_type", kind: "enum", T: () => ["proto.APLValueAutoSwingTime.SwingType", APLValueAutoSwingTime_SwingType] }
        ]);
    }
    create(value?: PartialMessage<APLValueAutoSwingTime>): APLValueAutoSwingTime {
        const message = { autoType: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueAutoSwingTime>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueAutoSwingTime): APLValueAutoSwingTime {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* proto.APLValueAutoSwingTime.SwingType auto_type */ 1:
                    message.autoType = reader.int32();
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: APLValueAutoSwingTime, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* proto.APLValueAutoSwingTime.SwingType auto_type = 1; */
        if (message.autoType !== 0)
            writer.tag(1, WireType.Varint).int32(message.autoType);
        let u = options.writeUnknownFields;
        if (u !== false)
...
/**
 * @generated MessageType for protobuf message proto.APLValueAutoSwingTime
 */
export const APLValueAutoSwingTime = new APLValueAutoSwingTime$Type();
// @generated message type with reflection information, may provide speed optimized methods
class APLValueSpellIsKnown$Type extends MessageType<APLValueSpellIsKnown> {
    constructor() {
        super("proto.APLValueSpellIsKnown", [
            { no: 1, name: "spell_id", kind: "message", T: () => ActionID }
        ]);
    }
    create(value?: PartialMessage<APLValueSpellIsKnown>): APLValueSpellIsKnown {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueSpellIsKnown>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueSpellIsKnown): APLValueSpellIsKnown {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: APLValueSpellIsKnown, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* proto.ActionID spell_id = 1; */
        if (message.spellId)
            ActionID.internalBinaryWrite(message.spellId, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
...
/**
 * @generated MessageType for protobuf message proto.APLValueSpellIsKnown
 */
export const APLValueSpellIsKnown = new APLValueSpellIsKnown$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
// @generated message type with reflection information, may provide speed optimized methods
class APLValueSpellInFlight$Type extends MessageType<APLValueSpellInFlight> {
    constructor() {
        super("proto.APLValueSpellInFlight", [
            { no: 1, name: "spell_id", kind: "message", T: () => ActionID }
        ]);
    }
    create(value?: PartialMessage<APLValueSpellInFlight>): APLValueSpellInFlight {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueSpellInFlight>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueSpellInFlight): APLValueSpellInFlight {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: APLValueSpellInFlight, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* proto.ActionID spell_id = 1; */
        if (message.spellId)
            ActionID.internalBinaryWrite(message.spellId, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
...
/**
 * @generated MessageType for protobuf message proto.APLValueSpellInFlight
 */
export const APLValueSpellInFlight = new APLValueSpellInFlight$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
// @generated message type with reflection information, may provide speed optimized methods
class APLValueSpellFullCooldown$Type extends MessageType<APLValueSpellFullCooldown> {
    constructor() {
        super("proto.APLValueSpellFullCooldown", [
            { no: 1, name: "spell_id", kind: "message", T: () => ActionID }
        ]);
    }
    create(value?: PartialMessage<APLValueSpellFullCooldown>): APLValueSpellFullCooldown {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueSpellFullCooldown>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueSpellFullCooldown): APLValueSpellFullCooldown {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: APLValueSpellFullCooldown, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* proto.ActionID spell_id = 1; */
        if (message.spellId)
            ActionID.internalBinaryWrite(message.spellId, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
...
/**
 * @generated MessageType for protobuf message proto.APLValueSpellFullCooldown
 */
export const APLValueSpellFullCooldown = new APLValueSpellFullCooldown$Type();
// @generated message type with reflection information, may provide speed optimized methods
class APLValueAuraIsKnown$Type extends MessageType<APLValueAuraIsKnown> {
    constructor() {
        super("proto.APLValueAuraIsKnown", [
            { no: 2, name: "source_unit", kind: "message", T: () => UnitReference },
            { no: 1, name: "aura_id", kind: "message", T: () => ActionID }
        ]);
    }
    create(value?: PartialMessage<APLValueAuraIsKnown>): APLValueAuraIsKnown {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueAuraIsKnown>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueAuraIsKnown): APLValueAuraIsKnown {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: APLValueAuraIsKnown, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
/**
 * @generated MessageType for protobuf message proto.APLValueAuraIsKnown
 */
export const APLValueAuraIsKnown = new APLValueAuraIsKnown$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
// @generated message type with reflection information, may provide speed optimized methods
class APLValueAuraIsInactive$Type extends MessageType<APLValueAuraIsInactive> {
    constructor() {
        super("proto.APLValueAuraIsInactive", [
            { no: 2, name: "source_unit", kind: "message", T: () => UnitReference },
            { no: 1, name: "aura_id", kind: "message", T: () => ActionID }
        ]);
    }
    create(value?: PartialMessage<APLValueAuraIsInactive>): APLValueAuraIsInactive {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueAuraIsInactive>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueAuraIsInactive): APLValueAuraIsInactive {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: APLValueAuraIsInactive, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* proto.UnitReference source_unit = 2; */
        if (message.sourceUnit)
            UnitReference.internalBinaryWrite(message.sourceUnit, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* proto.ActionID aura_id = 1; */
...
/**
 * @generated MessageType for protobuf message proto.APLValueAuraIsInactive
 */
export const APLValueAuraIsInactive = new APLValueAuraIsInactive$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
// @generated message type with reflection information, may provide speed optimized methods
class APLValueAuraDuration$Type extends MessageType<APLValueAuraDuration> {
    constructor() {
        super("proto.APLValueAuraDuration", [
            { no: 2, name: "source_unit", kind: "message", T: () => UnitReference },
            { no: 1, name: "aura_id", kind: "message", T: () => ActionID }
        ]);
    }
    create(value?: PartialMessage<APLValueAuraDuration>): APLValueAuraDuration {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueAuraDuration>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueAuraDuration): APLValueAuraDuration {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: APLValueAuraDuration, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* proto.UnitReference source_unit = 2; */
        if (message.sourceUnit)
            UnitReference.internalBinaryWrite(message.sourceUnit, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* proto.ActionID aura_id = 1; */
...
/**
 * @generated MessageType for protobuf message proto.APLValueAuraDuration
 */
export const APLValueAuraDuration = new APLValueAuraDuration$Type();
// @generated message type with reflection information, may provide speed optimized methods
class APLValueRuneIsEquipped$Type extends MessageType<APLValueRuneIsEquipped> {
    constructor() {
        super("proto.APLValueRuneIsEquipped", [
            { no: 1, name: "rune_id", kind: "message", T: () => ActionID }
        ]);
    }
    create(value?: PartialMessage<APLValueRuneIsEquipped>): APLValueRuneIsEquipped {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueRuneIsEquipped>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueRuneIsEquipped): APLValueRuneIsEquipped {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* proto.ActionID rune_id */ 1:
                    message.runeId = ActionID.internalBinaryRead(reader, reader.uint32(), options, message.runeId);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: APLValueRuneIsEquipped, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* proto.ActionID rune_id = 1; */
        if (message.runeId)
            ActionID.internalBinaryWrite(message.runeId, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message proto.APLValueRuneIsEquipped
 */
export const APLValueRuneIsEquipped = new APLValueRuneIsEquipped$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
// @generated message type with reflection information, may provide speed optimized methods
class APLValueDotTimeToNextTick$Type extends MessageType<APLValueDotTimeToNextTick> {
    constructor() {
        super("proto.APLValueDotTimeToNextTick", [
            { no: 2, name: "target_unit", kind: "message", T: () => UnitReference },
            { no: 1, name: "spell_id", kind: "message", T: () => ActionID }
        ]);
    }
    create(value?: PartialMessage<APLValueDotTimeToNextTick>): APLValueDotTimeToNextTick {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueDotTimeToNextTick>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueDotTimeToNextTick): APLValueDotTimeToNextTick {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: APLValueDotTimeToNextTick, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* proto.UnitReference target_unit = 2; */
        if (message.targetUnit)
            UnitReference.internalBinaryWrite(message.targetUnit, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* proto.ActionID spell_id = 1; */
...
/**
 * @generated MessageType for protobuf message proto.APLValueDotTimeToNextTick
 */
export const APLValueDotTimeToNextTick = new APLValueDotTimeToNextTick$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
// @generated message type with reflection information, may provide speed optimized methods
class APLValueWarlockCurrentPetMana$Type extends MessageType<APLValueWarlockCurrentPetMana> {
    constructor() {
        super("proto.APLValueWarlockCurrentPetMana", []);
    }
    create(value?: PartialMessage<APLValueWarlockCurrentPetMana>): APLValueWarlockCurrentPetMana {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueWarlockCurrentPetMana>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueWarlockCurrentPetMana): APLValueWarlockCurrentPetMana {
        return target ?? this.create();
    }
    internalBinaryWrite(message: APLValueWarlockCurrentPetMana, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message proto.APLValueWarlockCurrentPetMana
 */
export const APLValueWarlockCurrentPetMana = new APLValueWarlockCurrentPetMana$Type();
// @generated message type with reflection information, may provide speed optimized methods
class APLValueWarlockCurrentPetManaPercent$Type extends MessageType<APLValueWarlockCurrentPetManaPercent> {
    constructor() {
        super("proto.APLValueWarlockCurrentPetManaPercent", []);
    }
    create(value?: PartialMessage<APLValueWarlockCurrentPetManaPercent>): APLValueWarlockCurrentPetManaPercent {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueWarlockCurrentPetManaPercent>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueWarlockCurrentPetManaPercent): APLValueWarlockCurrentPetManaPercent {
        return target ?? this.create();
    }
    internalBinaryWrite(message: APLValueWarlockCurrentPetManaPercent, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message proto.APLValueWarlockCurrentPetManaPercent
 */
export const APLValueWarlockCurrentPetManaPercent = new APLValueWarlockCurrentPetManaPercent$Type();
// @generated message type with reflection information, may provide speed optimized methods
class APLValueWarlockPetIsActive$Type extends MessageType<APLValueWarlockPetIsActive> {
    constructor() {
        super("proto.APLValueWarlockPetIsActive", []);
    }
    create(value?: PartialMessage<APLValueWarlockPetIsActive>): APLValueWarlockPetIsActive {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueWarlockPetIsActive>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueWarlockPetIsActive): APLValueWarlockPetIsActive {
        return target ?? this.create();
    }
    internalBinaryWrite(message: APLValueWarlockPetIsActive, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message proto.APLValueWarlockPetIsActive
 */
export const APLValueWarlockPetIsActive = new APLValueWarlockPetIsActive$Type();
// @generated message type with reflection information, may provide speed optimized methods
class APLValueCurrentSealRemainingTime$Type extends MessageType<APLValueCurrentSealRemainingTime> {
    constructor() {
        super("proto.APLValueCurrentSealRemainingTime", []);
    }
    create(value?: PartialMessage<APLValueCurrentSealRemainingTime>): APLValueCurrentSealRemainingTime {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueCurrentSealRemainingTime>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueCurrentSealRemainingTime): APLValueCurrentSealRemainingTime {
        return target ?? this.create();
    }
    internalBinaryWrite(message: APLValueCurrentSealRemainingTime, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message proto.APLValueCurrentSealRemainingTime
 */
export const APLValueCurrentSealRemainingTime = new APLValueCurrentSealRemainingTime$Type();
// @generated message type with reflection information, may provide speed optimized methods
class APLActionGroupReference$Type extends MessageType<APLActionGroupReference> {
    constructor() {
        super("proto.APLActionGroupReference", [
            { no: 1, name: "group_name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "variables", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => APLValueVariable }
        ]);
    }
    create(value?: PartialMessage<APLActionGroupReference>): APLActionGroupReference {
        const message = { groupName: "", variables: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLActionGroupReference>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLActionGroupReference): APLActionGroupReference {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* string group_name */ 1:
                    ...
                    break;
                case /* repeated proto.APLValueVariable variables */ 2:
                    message.variables.push(APLValueVariable.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: APLActionGroupReference, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string group_name = 1; */
        if (message.groupName !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.groupName);
        /* repeated proto.APLValueVariable variables = 2; */
        for (let i = 0; i < message.variables.length; i++)
            APLValueVariable.internalBinaryWrite(message.variables[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message proto.APLActionGroupReference
 */
export const APLActionGroupReference = new APLActionGroupReference$Type();
// @generated message type with reflection information, may provide speed optimized methods
class APLValueVariable$Type extends MessageType<APLValueVariable> {
    constructor() {
        super("proto.APLValueVariable", [
            { no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "value", kind: "message", T: () => APLValue }
        ]);
    }
    create(value?: PartialMessage<APLValueVariable>): APLValueVariable {
        const message = { name: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueVariable>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueVariable): APLValueVariable {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* string name */ 1:
                    message.name = reader.string();
                    break;
                case /* proto.APLValue value */ 2:
                    message.value = APLValue.internalBinaryRead(reader, reader.uint32(), options, message.value);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: APLValueVariable, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string name = 1; */
        if (message.name !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.name);
        /* proto.APLValue value = 2; */
        if (message.value)
            APLValue.internalBinaryWrite(message.value, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message proto.APLValueVariable
 */
export const APLValueVariable = new APLValueVariable$Type();
// @generated message type with reflection information, may provide speed optimized methods
class APLValueVariableRef$Type extends MessageType<APLValueVariableRef> {
    constructor() {
        super("proto.APLValueVariableRef", [
            { no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<APLValueVariableRef>): APLValueVariableRef {
        const message = { name: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueVariableRef>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueVariableRef): APLValueVariableRef {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: APLValueVariableRef, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string name = 1; */
        if (message.name !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.name);
        let u = options.writeUnknownFields;
...
/**
 * @generated MessageType for protobuf message proto.APLValueVariableRef
 */
export const APLValueVariableRef = new APLValueVariableRef$Type();
// @generated message type with reflection information, may provide speed optimized methods
class APLValueVariablePlaceholder$Type extends MessageType<APLValueVariablePlaceholder> {
    constructor() {
        super("proto.APLValueVariablePlaceholder", [
            { no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<APLValueVariablePlaceholder>): APLValueVariablePlaceholder {
        const message = { name: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueVariablePlaceholder>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueVariablePlaceholder): APLValueVariablePlaceholder {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: APLValueVariablePlaceholder, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string name = 1; */
        if (message.name !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.name);
        let u = options.writeUnknownFields;
...
/**
 * @generated MessageType for protobuf message proto.APLValueVariablePlaceholder
 */
export const APLValueVariablePlaceholder = new APLValueVariablePlaceholder$Type();
// @generated message type with reflection information, may provide speed optimized methods
class APLValueActionGroupUsed$Type extends MessageType<APLValueActionGroupUsed> {
    constructor() {
        super("proto.APLValueActionGroupUsed", [
            { no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<APLValueActionGroupUsed>): APLValueActionGroupUsed {
        const message = { name: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<APLValueActionGroupUsed>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: APLValueActionGroupUsed): APLValueActionGroupUsed {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: APLValueActionGroupUsed, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string name = 1; */
        if (message.name !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.name);
        let u = options.writeUnknownFields;
...
/**
 * @generated MessageType for protobuf message proto.APLValueActionGroupUsed
 */
export const APLValueActionGroupUsed = new APLValueActionGroupUsed$Type();
