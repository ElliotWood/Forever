...
// TODO: To be implemented. Secrets of the Light is content Forever added; the sim has never
...
// SpellMask: PriestSpellSecretsOfTheLight
//
...
func (priest *Priest) registerSecretsOfTheLight() {
