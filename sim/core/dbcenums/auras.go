...
// Enum constants defined using the A_ naming convention. Every id is listed; one no name is known for
// is A_<id>.
const (
	...
	A_MOD_CHARGE_RECOVERY_RATE_BY_TYPE_MASK           EffectAuraType = 173
	...
	A_MOUNT_ANIM_REPLACEMENT_SET                      EffectAuraType = 313
	...
	A_MOD_CURRENCY_CATEGORY_GAIN_PCT                  EffectAuraType = 351
	A_352                                             EffectAuraType = 352
	A_MOD_CAMOUFLAGE                                  EffectAuraType = 353
	A_MOD_HEALING_DONE_PCT_VERSUS_TARGET_HEALTH       EffectAuraType = 354
	...
	A_MOD_ADV_FLYING_AIR_FRICTION                     EffectAuraType = 513
	A_MOD_ADV_FLYING_MAX_VEL                          EffectAuraType = 514
	A_MOD_ADV_FLYING_LIFT_COEF                        EffectAuraType = 515
	A_516                                             EffectAuraType = 516
	A_517                                             EffectAuraType = 517
	A_MOD_ADV_FLYING_ADD_IMPULSE_MAX_SPEED            EffectAuraType = 518
	A_MOD_COOLDOWN_RECOVERY_RATE_ALL                  EffectAuraType = 519
	A_MOD_ADV_FLYING_BANKING_RATE                     EffectAuraType = 520
	A_MOD_ADV_FLYING_PITCHING_RATE_DOWN               EffectAuraType = 521
	A_MOD_ADV_FLYING_PITCHING_RATE_UP                 EffectAuraType = 522
	A_523                                             EffectAuraType = 523
	A_MOD_ADV_FLYING_OVER_MAX_DECELERATION            EffectAuraType = 524
	...
	A_530                                             EffectAuraType = 530
	A_531                                             EffectAuraType = 531
	...
	A_MOD_SPELL_DAMAGE_FROM_CASTER_BY_LABEL           EffectAuraType = 537
	...
	A_MOVE_SET_CANT_SWIM                              EffectAuraType = 545
	...
	A_637                                             EffectAuraType = 637
	A_638                                             EffectAuraType = 638
	A_639                                             EffectAuraType = 639
	A_640                                             EffectAuraType = 640
	A_641                                             EffectAuraType = 641
	A_642                                             EffectAuraType = 642
	A_643                                             EffectAuraType = 643
	A_644                                             EffectAuraType = 644
	A_645                                             EffectAuraType = 645
	A_646                                             EffectAuraType = 646
	A_647                                             EffectAuraType = 647
	A_648                                             EffectAuraType = 648
	A_649                                             EffectAuraType = 649
