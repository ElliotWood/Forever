...
// e.g. spellData.NaturesReach.ValueAt(2) is 20, the client's number as it stands
...
// e.g. spellData.Bloodthrill.FractionAt(5) is 0.10, from 10
...
// e.g. spellData.ImprovedBloodrage.MultiplierAt(2) is 1.5, from 50
...
// e.g. spellData.ImprovedCharge.TenthsAt(2) is 6 rage, from 60
// e.g. spellData.BoundlessRage.TenthsAt(3) is 30 rage, from 300
...
// e.g. spellData.ShieldSpecialization.EffectAt(1).ValueAt(3) is the chance effect's 60
...
// e.g. spellData.BloodCraze.EffectAt(1).FractionAt(3) is 0.2, from 20
...
// e.g. spellData.DualWieldSpecialization.EffectAt(1).MultiplierAt(3) is 1.6, from 60
...
// e.g. spellData.RagingBlows.EffectAt(1).TenthsAt(1) is -2 rage on Cleave, from -20
