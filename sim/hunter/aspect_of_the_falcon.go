...
// TODO: To be implemented. Aspect of the Falcon is content Forever added; the sim has never
...
// SpellMask: HunterSpellAspectOfTheFalcon
//
...
func (hunter *Hunter) registerAspectOfTheFalcon() {
