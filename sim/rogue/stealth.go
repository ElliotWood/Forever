...
// TODO: To be implemented. Stealth already resolves against Forever data
// (spellData.Stealth.BySpellID(1784)); the TBC body needs review before it's uncommented.
